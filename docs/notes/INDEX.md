...
| [08-07 form hardening](2026-08-07-update-form-hardening.md) | Feature | Inquiry form hardening: same-origin relay, server-side key, honeypot/origin/validation/rate-limit | Shipped + verified end-to-end Aug 7 (key rotation cancelled by owner decision) | 4992f65 |
